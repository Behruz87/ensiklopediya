...
!function (e) {
    ...
    e.fn.bxSlider = function (n) {
        ...
        var s = {}, o = this, r = e(window).width(), a = e(window).height(), l = function () {
            ...
            if (3 * n > o && s.settings.preventDefaultSwipeX ? e.preventDefault() : 3 * o > n && s.settings.preventDefaultSwipeY && e.preventDefault(), "F" !== s.settings.mode && s.settings.oneToOneTouch) {
                var r = 0, a = 0;
